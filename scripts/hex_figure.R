######################################################################
# Code for creating US hex and PA county figure of COVID-19 incidence
# Updated: Updated November 1, 2020
######################################################################
...
############################################
# Load data
# Load time series data from Johns Hopkins CSSE github account
